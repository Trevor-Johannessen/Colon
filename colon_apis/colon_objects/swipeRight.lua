...
function create(args)
	...
	for i=screen_width, 0, -3 do
		term.clear()
		colon.redraw{pageName=to, x_offset=-i, x_inital=0, x_final=screen_width-i}
		colon.redraw{pageName=from, x_offset=screen_width-i, x_inital=screen_width-i, x_final=screen_width}
