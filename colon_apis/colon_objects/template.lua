function create()
    ...
    function template:parseColor(str)
        colorString = string.rep(template:int_to_hex(term.getTextColor()), str:len())
        backgroundString = string.rep(template:int_to_hex(term.getBackgroundColor()), str:len())
        while true do
    ...
    function template:str_to_int(str)
    ...
    function template:int_to_hex(color)
    ...
    function template:str_to_hex(str)
        str = string.lower(str)
