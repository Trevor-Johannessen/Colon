function create(args)
    ...
    loadbar.x = args.x or 0 -- x coordinate of loadbar
    loadbar.y = args.y or 0 -- y coordinate of loadbar
    loadbar.length = args.length or 10 -- length of loadbar (bar is x characters long)
